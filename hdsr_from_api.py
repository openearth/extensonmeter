...
from ts_helpders_hdsr import establishconnection, read_config, loadfilesource,location,sparameter,sserieskey,sflag,dateto_integer,convertlttodate, stimestep
                                ...
                                while t["next"]: #iteration trhough all the different timeseries page, continue as long as there is a next page
                                    ...
                                    if df.flag.size > 0:
                                        ...
                                        if r!=(df['datetime'].iloc[-1]).replace(tzinfo=None):
                                            ...
                                            df['flags'] = flagkey
                                            df.to_sql('timeseriesvaluesandflags',engine,index=False,if_exists='append',schema='hdsr_timeseries')
